...
import com.leyou.game.util.AppUtil;
...
public class AboutActivity extends BaseActivity implements IAboutActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.re_about_go_judge:
                AppUtil.startMarketAppDetail(getPackageName());
                break;
    ...
    private void share() {
        handler.post(new Runnable() {
            ...
            public void run() {
                //友盟微信朋友圈分享
                UMImage umImage = new UMImage(AboutActivity.this, BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher));
    ...
    private void clearAppCache() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            CookieSyncManager.createInstance(GameApplication.getContext());
