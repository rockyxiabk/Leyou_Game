...
public class WorkerDismissActivity extends BaseActivity implements IWorkerDismissActivity, CustomItemClickListener {
    ...
    @BindView(R.id.iv_dismiss_explain)
    ImageButton tvDismissExplain;
    ...
    @OnClick({R.id.iv_dismiss_back, R.id.iv_dismiss_explain, R.id.btn_dismiss_worker_confirm})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_dismiss_back:
                finishCurrentActivity();
                break;
            case R.id.iv_dismiss_explain:
                WebViewDialog webViewDialog = new WebViewDialog(this, getString(R.string.treasure_dismissed_explain), Constants.TREASURE_WORKER_DISMISS);
                webViewDialog.show();
                break;
