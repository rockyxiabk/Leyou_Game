...
public class ContactsListAdapter extends RecyclerView.Adapter<ContactsListAdapter.ViewHolder> implements SectionIndexer {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvContactName.setText(!TextUtils.isEmpty(contactBean.getComment()) ? contactBean.getComment() : contactBean.getNickname());
        ...
        holder.reContactItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(friend.getUserId())) {
                    UserInfo userInfo = new UserInfo(friend.getUserId(), !TextUtils.isEmpty(contactBean.getName()) ? contactBean.getName() : contactBean.getNickname(), Uri.parse(friend.getHeadImgUrl()));
