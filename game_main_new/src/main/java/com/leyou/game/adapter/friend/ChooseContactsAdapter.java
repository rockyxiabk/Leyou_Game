 ...
 */
public class ChooseContactsAdapter extends RecyclerView.Adapter<ChooseContactsAdapter.ViewHolder> implements SectionIndexer {
    private Context context;
    private List<Friend> list;
    private GameBean gameBean;
    private CustomItemClickListener listener;

    public ChooseContactsAdapter(Context context, List<Friend> list, GameBean gameBean) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvContactName.setText(!TextUtils.isEmpty(contactBean.getComment()) ?
                contactBean.getComment() : contactBean.getNickname());
