...
import com.leyou.game.widget.dialog.mine.SellDiamondDialog;
...
public class ExChangeBuyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExChangeBuyAdapter(Context context, List<DiamondExchangeBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, int position) {
        ...
        if (holder1 instanceof ExChangeHolder) {
            ...
            holder.tvDiamondPrice.setText("" + exChangeBean.price + "元/钻");
            holder.tvDiamondNumber.setText("" + exChangeBean.diamondsNum + "");
            holder.cdItemPurchase.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public class ExChangeHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.cd_item_purchase)
        CardView cdItemPurchase;
