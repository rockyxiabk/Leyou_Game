...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paints[0].setTextSize(ScreenUtil.sp2px(context, 20));
        paints[0].setTypeface(Typeface.DEFAULT_BOLD); // 设置字体
        float textWidth = paints[0].measureText(msg);
        canvas.drawText(msg, centre - textWidth / 2, centre + ScreenUtil.sp2px(context, 20) / 2, paints[0]); // 画出进度百分比
    }
