 ...
 *
 * @author : rocky
 * @Create Time : 2017/6/23 下午1:28
 * @Modified Time : 2017/6/23 下午1:28
 */
public class TreasureBigAdapter extends RecyclerView.Adapter<TreasureBigAdapter.ViewHolder> {
    ...
    public TreasureBigAdapter(Context context, List<TreasureBean> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public TreasureBigAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_treasure_time_big_list, parent, false);
        TreasureBigAdapter.ViewHolder holder = new TreasureBigAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(TreasureBigAdapter.ViewHolder holder, final int position) {
    ...
    public void setTreasureBigAdapter(List<TreasureBean> treasureBeanList) {
        list.clear();
