...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, final int position) {
        ...
        if (holder1 instanceof MessageHolder) {
            ...
            messageHolder.tvMessageListTime.setText(DataUtil.msg_distance_time(messageBean.createTime, System.currentTimeMillis()));
            ...
            messageHolder.reMessageListItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    setRead(position);
                    if (messageBean.msgType == 1) {
                        new MessageDialog(context, messageBean.id, messageBean.title, messageBean.content, messageBean.createTime).show();
                    } else if (messageBean.msgType == 2) {
