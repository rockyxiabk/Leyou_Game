...
public class CrowdMemberAdapter extends RecyclerView.Adapter<CrowdMemberAdapter.ViewHolder> implements RongIM.GroupUserInfoProvider {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.ivMemberHead.setImageURI(friend.getHeadImgUrl());
        holder.tvMemberNickName.setText(!TextUtils.isEmpty(friend.getName()) ? friend.getName() : friend.getNickname());
        ...
        holder.ivMemberHead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("0".equalsIgnoreCase(friend.getUserId())) {//删除好友
                    ...
                    UserInfo userInfo = new UserInfo(friend.getUserId(), friend.getName(), Uri.parse(friend.getHeadImgUrl()));
