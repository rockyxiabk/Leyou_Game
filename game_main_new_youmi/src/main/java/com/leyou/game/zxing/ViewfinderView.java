...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        mRect = new Rect();
        int left = getResources().getColor(R.color.theme_color);
        int center = getResources().getColor(R.color.theme_color_touch);
        int right = getResources().getColor(R.color.theme_color);
        lineDrawable = getResources().getDrawable(R.mipmap.icon_zx_code_line);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            paint.setColor(getResources().getColor(R.color.theme_color_touch));
