 ...
 *
 * @author : rocky
 * @Create Time : 2017/3/24 上午11:01
 * @Modified By: rocky
 * @Modified Time : 2017/3/24 上午11:01
 */
public class ServiceManager {

    private static ConnectivityManager cm;//网络状态
    private static LocationManager locationManager;
    private static TelephonyManager telephonyManager;//手机信息
    private static InputMethodManager inputMethodManager;//系统键盘
    private static Vibrator vibrator;//震动器
    private static SensorManager sensorManager;//传感器
    private static Sensor accelerometerSensor;//加速器
    private static Sensor lightSensor;//光线传感器引用
    private static LayoutInflater inflater;//布局管理
    private static AudioManager audioManager;//音频管理
