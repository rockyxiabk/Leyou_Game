...
//        mAudioManager.abandonAudioFocus(audioFocusChangeListener);
    ...
    @Override
    public void showYouMiVideoAd() {
//        VideoAdSettings videoAdSettings = new VideoAdSettings();
//        videoAdSettings.setInterruptTips("温馨提示\n观看广告可免费进入游戏！");
//        VideoAdManager.getInstance(this).showVideoAd(this, videoAdSettings, new VideoAdListener() {
//            @Override
...
//        });
        ...
        //设置插屏图片类型，默认竖图
        if (gameBean.screenDirection == 1) {//横图
