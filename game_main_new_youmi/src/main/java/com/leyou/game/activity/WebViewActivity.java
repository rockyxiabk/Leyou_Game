...
public class WebViewActivity extends BaseWebViewActivity {
    ...
    protected void onDestroy() {
        super.onDestroy();
        LogUtil.e(TAG, "youmi banner ad show failed");
    }
    ...
    private void addAdView() {
        ...
        View bannerView = BannerManager.getInstance(this).getBannerView(this, new BannerViewListener() {
            ...
            public void onRequestSuccess() {
                LogUtil.e(TAG, "youmi banner ad show success");
                llBannerAd.setVisibility(View.VISIBLE);
            }

            @Override
            public void onSwitchBanner() {
                LogUtil.e(TAG, "youmi banner ad show next");
                llBannerAd.setVisibility(View.VISIBLE);
            }
