 ...
 *
 * @author : rocky
 * @Create Time : 2017/6/20 下午1:29
 * @Modified Time : 2017/6/20 下午1:29
 */
public class ChooseWorkerCanUseAdapter extends RecyclerView.Adapter<ChooseWorkerCanUseAdapter.WorkerHolder> {
    private Context context;
    private List<WorkerBean> list;
    private ChoseUseItemClickListener listener;
    private Map<Integer, Boolean> map = new HashMap<>();
    private int choseCount = 0;
    private int selectNum = 5;

    public ChooseWorkerCanUseAdapter(Context context, List<WorkerBean> list) {
        this.context = context;
        this.list = list;
    }

    public void setChoseItemClickListener(ChoseUseItemClickListener listener) {
    ...
    public interface ChoseUseItemClickListener {
        void choseUseMap(Map<Integer, Boolean> map);
    }
