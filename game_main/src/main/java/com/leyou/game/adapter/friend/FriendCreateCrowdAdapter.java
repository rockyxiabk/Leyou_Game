...
public class FriendCreateCrowdAdapter extends RecyclerView.Adapter<FriendCreateCrowdAdapter.ViewHolder> implements SectionIndexer {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvContactName.setText(!TextUtils.isEmpty(contactBean.getRemarkName()) ? contactBean.getRemarkName() : !TextUtils.isEmpty(contactBean.getName()) ? contactBean.getName() : contactBean.getNickName());
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(contactBean.getPhone()) || !contactBean.getPhone().equalsIgnoreCase(UserData.getInstance().getPhoneNum())) {
                    setMap(position);
                    holder.checkBox.setChecked(map.get(position));
                }
            }
