 ...
 */
public class EnemyWorkerAdapter extends RecyclerView.Adapter<EnemyWorkerAdapter.WorkerHolder> {
    private Context context;
    private List<WorkerBean> list;

    public EnemyWorkerAdapter(Context context, List<WorkerBean> list) {
        this.context = context;
        this.list = list;
    }

    public EnemyWorkerAdapter(Context context, List<WorkerBean> list, boolean flag) {
        this.context = context;
        this.list = list;
    }
    ...
    private void onWorkerHolder(final WorkerHolder holder, final int position) {
        ...
        holder.cbCheckedWorker.setVisibility(View.GONE);
    }
