...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private OnTargetCallback onTargetListener;
...
//        backgroundColor = Color.parseColor("#00000000");
            ...
            if (direction != null) {
                ...
                switch (direction) {
                    case TOP:
                        ...
                        guideViewParams.setMargins(offsetX, offsetY - height + top, -offsetX, height - top - offsetY - radius / 2);
                        break;
                    case LEFT:
                    ...
                    case BOTTOM:
                        ...
                        guideViewParams.setMargins(offsetX, bottom + offsetY - radius / 2, -offsetX, -bottom - offsetY);
                        break;
                    case RIGHT:
                    ...
                    case LEFT_BOTTOM:
                        this.setGravity(Gravity.RIGHT);
                        guideViewParams.setMargins(offsetX - width + left, bottom + offsetY - radius, width - left - offsetX, -bottom - offsetY);
                        break;
                    case RIGHT_TOP:
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (backgroundColor != 0)
            ...
            bgPaint.setColor(getResources().getColor(R.color.shadow_guide_view));
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                ...
                case SQUARE://正方形
                    ...
                    oval.right = center[0] + targetView.getWidth() / 2 + 10;                             //右边
                    oval.bottom = center[1] + targetView.getHeight() / 2 + 10;                                //下边
                    temp.drawRoundRect(oval, 0, 0, mCirclePaint);                   //绘制矩形
                    break;
    ...
    public void setTargetViewListener(OnTargetCallback onTargetCallback) {
        this.onTargetListener = onTargetCallback;
    }
    ...
    private void setClickInfo() {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != onTargetListener) {
                    onTargetListener.onClickTargetView();
                }
...
//        });
    ...
    /**
     * 定义目标控件的形状，共3种。圆形，椭圆，带圆角的矩形（可以设置圆角大小），正方形，不设置则默认是圆形
     */
    public enum MyShape {
    ...
    public static class Builder {
        ...
        public Builder setTargetOnClickListener(final OnTargetCallback listener) {
            guiderView.setTargetViewListener(listener);
            return instance;
        }
