...
public class NewVersionDialog extends BaseDialog {
    ...
    protected void initView() {
        ...
        tvVersionDes.setText(updateAppBean.upgradeDes);
        checkFile();
    }

    private void checkFile() {
        File file = new File(Constants.UPDATE_DIR + updateAppBean.appName + "-" + updateAppBean.versionCode + ".apk");
        if (file.exists()) {
            PackageManager packageManager = context.getPackageManager();
            PackageInfo packageInfo = packageManager.getPackageArchiveInfo(Constants.UPDATE_DIR + updateAppBean.appName + "-" + updateAppBean.versionCode + ".apk", 0);
    ...
    private void install() {
        ...
        intent.setDataAndType(Uri.fromFile(new File(Constants.UPDATE_DIR + updateAppBean.appName + "-" + updateAppBean.versionCode + ".apk")), "application/vnd.android.package-archive");
